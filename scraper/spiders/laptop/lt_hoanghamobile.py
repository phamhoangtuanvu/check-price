...
# Class craw data
class lt_hoanghamobile(scrapy.Spider):
    name = 'lt_hoanghamobile'
    ...
    def get_detail(self, response):
        ...
        attributes = []
        option_old_price = response.css('::attr(data-bestprice)').get()
        option_new_price = response.css('::attr(data-lastprice)').get()
